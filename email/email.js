...
const sendEmailTo = (emailAddr, username, key) => {
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      ...
      clientId: process.env.emailCliendID,
  ...
  const mailOptions = {
    ...
    to: emailAddr,
    subject: 'IntuitionLog Registration',
    unsubscribe: {
